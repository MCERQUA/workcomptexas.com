          ...
          <div className="container-tight">
            ...
            <FadeIn className="mt-10">
              <div className="rounded-3xl bg-espresso text-cream p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div><p className="font-heading font-extrabold text-2xl">Featured Texas regions</p><p className="text-cream/75 mt-1">Dedicated pages for key Texas contractor markets.</p></div>
